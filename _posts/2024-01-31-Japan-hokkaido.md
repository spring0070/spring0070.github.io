...
{% include custom-nav-links.html src="Japan_Hokkaido_Overview.png" data="photo" title="photo" %} 
{% include custom-nav-links.html src="Japan_Hokkaido_AI_Generated.jpeg" data="photo" title="photo" %} *AI畫得很美但好像沒這些東西!* 
...
{% include custom-nav-links.html src="Japan_Hokkaido_Jigokudani.png" data="photo" title="photo" %}*AI generated!* 
<!-- 圖片：DSC01540-47.JPG - 此檔案不存在，已移除引用 -->
...
{% include custom-nav-links.html src="Japan_Hokkaido_Kanemori_Warehouse.png" data="photo" title="photo" %}*AI generated!* 
...
{% include custom-nav-links.html src="Japan_Hokkaido_Hakodate_Ropeway.jpeg" data="photo" title="photo" %}*AI generated!* 
...
{% include custom-nav-links.html src="Japan_Hokkaido_Goryokaku.jpg" data="photo" title="photo" %} 
{% include custom-nav-links.html src="Japan_Hokkaido_Photo3.JPG" data="photo" title="photo" %} 
...
{% include custom-nav-links.html src="Japan_Hokkaido_Toyako_Onsen.png" data="photo" title="photo" %}
*AI generated!* 
{% include custom-nav-links.html src="Japan_Hokkaido_Photo9.JPG" data="photo" title="photo" %}
...
{% include custom-nav-links.html src="Japan_Hokkaido_Cable_Car.jpg" data="photo" title="photo" %}
*AI generated!* 
{% include custom-nav-links.html src="Japan_Hokkaido_Photo10.JPG" data="photo" title="photo" %}
...
{% include custom-nav-links.html src="Japan_Hokkaido_Photo8.JPG" data="photo" title="photo" %}
